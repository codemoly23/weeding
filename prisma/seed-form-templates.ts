...
async function main() {
  ...
  const tab4Fields: FieldConfig[] = [
    ...
    },
    {
      ...
      label: "I understand that Ceremoney is a wedding planning service, not a law firm. This is not legal advice.",
      type: "CHECKBOX",
      helpText: "Ceremoney provides planning and coordination services, not legal counsel",
      order: 3,
      width: "FULL",
      required: true,
    },
    ...
    },
    {
      ...
      helpText: "By typing your name, you authorize Ceremoney to coordinate services on your behalf",
      order: 5,
      width: "FULL",
      required: true,
