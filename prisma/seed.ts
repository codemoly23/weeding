  ...
  const testimonials = [
    {
      ...
      company: "Bride",
      country: "Sweden",
      content: "EventPlanner Pro made our entire planning process feel effortless. The seating chart builder alone saved us hours of frustration. We could not recommend it more!",
      rating: 5,
      sortOrder: 1,
    },
    {
      ...
      company: "Groom",
      country: "Sweden",
      content: "As the groom who had no idea where to start, EventPlanner Pro's checklist guided us step-by-step. The vendor directory helped us find a fantastic photographer we would never have discovered otherwise.",
      rating: 5,
      sortOrder: 2,
    },
    {
...
<p>For questions about this disclaimer, contact us at <a href="mailto:legal@ceremoney.com">legal@ceremoney.com</a>.</p>`,
  ...
  console.log("\nActivating Wedding theme...");
  {
    ...
    const { importThemeData } = await import("../src/lib/theme/theme-importer");
    ...
    const result = await importThemeData(themeData, {
      source: "theme",
      themeId: "wedding",
