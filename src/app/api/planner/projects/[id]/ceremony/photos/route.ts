...
// POST /api/planner/projects/[id]/ceremony/photos — add a photo URL
export async function POST(
  ...
  const venue = await prisma.eventVenue.upsert({
    where: { projectId_type: { projectId: id, type: "CEREMONY" } },
    create: { projectId: id, type: "CEREMONY", photos: [url] },
...
// DELETE /api/planner/projects/[id]/ceremony/photos — remove a photo URL
