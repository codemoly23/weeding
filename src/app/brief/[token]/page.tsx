    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary/5 to-accent/5 flex items-center justify-center p-4">
        <div className="text-center max-w-sm">
          <XCircle className="w-12 h-12 text-[var(--color-error-text)] mx-auto mb-3" />
          <h1 className="text-lg font-semibold text-foreground">Brief not found</h1>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-white to-accent/5">
      ...
      <div className="bg-card border-b border-border/50 px-4 py-4">
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground border border-border rounded-lg px-3 py-1.5"
          >
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-5">
        {/* Title card */}
        <div className="bg-card rounded-2xl border border-primary/10 p-6 text-center shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
          <DetailCard
            icon={<Users className="w-4 h-4 text-[var(--color-info-text)]" />}
            label="Guest Count"
          ...
          {budgetDisplay && (
            <DetailCard
              icon={<DollarSign className="w-4 h-4 text-[var(--color-success-text)]" />}
              label="Total Budget"
              value={budgetDisplay}
              color="green"
            />
        ...
        <div className="bg-card rounded-2xl border border-border/50 p-5 shadow-sm">
          <h2 className="text-sm font-semibold text-foreground mb-4 flex items-center gap-2">
            <CheckCircle className="w-4 h-4 text-[var(--color-success-text)]" />
            Vendor Checklist
          </h2>
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
            {ALL_CATEGORIES.map((cat) => {
              ...
              return (
                ...
                >
                  {confirmed ? (
                    <CheckCircle className="w-3.5 h-3.5 text-[var(--color-success-text)] shrink-0" />
                  ) : (
...
function DetailCard({
  ...
  const bg = { blue: "bg-[var(--color-info-bg)]", green: "bg-[var(--color-success-bg)]", purple: "bg-primary/5" }[color];
  return (
  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div>
        ...
        {venue.capacity && (
          <p className="text-xs text-muted-foreground/70">Capacity: {venue.capacity}</p>
        )}
      </div>
    </div>
  );
