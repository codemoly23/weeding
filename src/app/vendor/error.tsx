...
export default function VendorError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="mx-auto max-w-md rounded-lg border border-red-200 bg-red-50 p-5 text-center">
      <h1 className="text-base font-semibold text-red-900">Vendor portal could not load.</h1>
      <p className="mt-1 text-sm text-red-700">Try loading this vendor page again.</p>
