    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-primary/5 via-background to-background">
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            🇺🇸 #1 Trusted LLC Formation Service for International Entrepreneurs
          </Badge>
          ...
          <div className="mx-auto max-w-3xl">
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
              {trustBadges.map((badge) => (
                <div
                  key={badge.text}
                  className="flex flex-col items-center gap-2 rounded-xl border bg-background/80 p-4 backdrop-blur"
                >
        ...
        <div className="mt-16 border-t pt-12">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            ...
            <div className="text-center">
              <p className="text-3xl font-bold text-primary sm:text-4xl">24h</p>
              <p className="mt-1 text-sm text-muted-foreground">
                Average Processing
              </p>
            </div>
