    ...
    >
      <div className="w-full px-6 lg:px-16 xl:px-24">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-white/80 px-5 py-2 text-sm font-semibold text-primary shadow-sm">
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="flex flex-col rounded-2xl bg-card p-8 shadow-md"
            >
              {/* Rating */}
              ...
              {/* Big Quote Mark */}
              <div className="mb-4 text-5xl font-bold leading-none text-primary/30 select-none">
                &#x275D;&#x275E;
              </div>
              ...
              {/* Divider */}
              <div className="my-6 h-0.5 w-14 bg-accent/30" />

              {/* Author */}
              <div className="flex items-center gap-4">
                <Avatar className="h-12 w-12">
                  <AvatarFallback className="bg-accent text-sm font-semibold text-primary-foreground">
