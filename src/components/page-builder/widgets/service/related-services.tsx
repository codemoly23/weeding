  ...
  const placeholderServices: RelatedService[] = [
    {
      ...
      shortDesc: "Build and manage your complete guest list with RSVP tracking and dietary requirements.",
      icon: "Users",
      startingPrice: 0,
      category: { name: "Core Features", slug: "core-features" },
    },
    {
      id: "p2",
      name: "Seating Chart Editor",
      slug: "seating-chart",
      shortDesc: "Drag-and-drop visual seating planner. Assign guests to tables and export a PDF.",
      icon: "LayoutGrid",
      startingPrice: 0,
      category: { name: "Core Features", slug: "core-features" },
    },
    {
      ...
      shortDesc: "Beautiful, customizable event website with online RSVP and photo gallery.",
      icon: "Globe",
      startingPrice: 0,
      category: { name: "Event Website", slug: "event-website" },
    },
    {
      id: "p4",
      name: "Vendor Directory",
      slug: "vendors",
      shortDesc: "Browse verified photographers, venues, florists, caterers, and more.",
      icon: "Camera",
      startingPrice: 0,
      category: { name: "Vendors", slug: "vendors" },
    },
  ];
