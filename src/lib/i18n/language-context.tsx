...
const translations: Record<LangCode, Record<string, string>> = {
  ...
  ar: {
    ...
    "nav.quickStart":               "بداية سريعة:",
    "nav.startPlanningFree":        "ابدأ التخطيط مجاناً",
    "nav.seatingChart":             "مخطط الجلوس",
    "nav.getInTouch":               "تواصل معنا",
    "nav.ourServices":              "خدماتنا",
    "nav.servicesDesc":             "حلول متكاملة لتخطيط الفعاليات للأزواج والمخططين",
    ...
    "common.startPlanning":         "ابدأ التخطيط",
    ...
    "ceremony.uploading":           "جارٍ الرفع...",
    "ceremony.uploadFailed":        "فشل الرفع. يرجى المحاولة مرة أخرى.",
    "ceremony.fileTooLarge":        "الملف كبير جداً. الحد الأقصى 20 ميغابايت.",
    "ceremony.maxPhotos":           "تم الوصول للحد الأقصى 30 صورة.",
    "ceremony.onlyImages":          "الملفات المدعومة هي الصور فقط.",
    ...
    "reception.uploading":          "جارٍ الرفع...",
    "reception.uploadFailed":       "فشل الرفع. يرجى المحاولة مرة أخرى.",
    "reception.fileTooLarge":       "الملف كبير جداً. الحد الأقصى 20 ميغابايت.",
    "reception.maxPhotos":          "تم الوصول للحد الأقصى 30 صورة.",
    "reception.onlyImages":         "الملفات المدعومة هي الصور فقط.",
  ...
  bn: {
    ...
    "nav.viewAllServices":          "সব সেবা দেখুন",
    "nav.quickStart":               "দ্রুত শুরু:",
    "nav.startPlanningFree":        "বিনামূল্যে পরিকল্পনা শুরু করুন",
    "nav.seatingChart":             "আসন বিন্যাস",
    "nav.getInTouch":               "যোগাযোগ করুন",
    "nav.ourServices":              "আমাদের সেবাসমূহ",
    "nav.servicesDesc":             "দম্পতি ও পরিকল্পনাকারীদের জন্য সম্পূর্ণ ইভেন্ট পরিকল্পনা সমাধান",
    ...
    "common.startPlanning":         "পরিকল্পনা শুরু করুন",
    ...
    "ceremony.uploading":           "আপলোড হচ্ছে...",
    "ceremony.uploadFailed":        "আপলোড ব্যর্থ হয়েছে। আবার চেষ্টা করুন।",
    "ceremony.fileTooLarge":        "ফাইল অনেক বড়। সর্বোচ্চ ২০ এমবি।",
    "ceremony.maxPhotos":           "সর্বোচ্চ ৩০টি ছবির সীমায় পৌঁছে গেছে।",
    "ceremony.onlyImages":          "শুধুমাত্র ছবি ফাইল সমর্থিত।",
    ...
    "reception.uploading":          "আপলোড হচ্ছে...",
    "reception.uploadFailed":       "আপলোড ব্যর্থ হয়েছে। আবার চেষ্টা করুন।",
    "reception.fileTooLarge":       "ফাইল অনেক বড়। সর্বোচ্চ ২০ এমবি।",
    "reception.maxPhotos":          "সর্বোচ্চ ৩০টি ছবির সীমায় পৌঁছে গেছে।",
    "reception.onlyImages":         "শুধুমাত্র ছবি ফাইল সমর্থিত।",
    ...
    "settings.saving":              "সংরক্ছন হচ্ছে...",
    "settings.saved":               "সংরক্ষিত হয়েছে",
    "settings.saveFailed":          "সংরক্ষণ ব্যর্থ হয়েছে। আবার চেষ্টা করুন।",
