...
import type {
  ...
  BlogPostHeroWidgetSettings,
  BlogPostContentWidgetSettings,
  BlogPostTocWidgetSettings,
  SocialShareRailWidgetSettings,
  BlogPostAuthorCardWidgetSettings,
  BlogPostTagsWidgetSettings,
...
export const DEFAULT_BREADCRUMB_SETTINGS: BreadcrumbWidgetSettings = {
  separator: "chevron",
  homeLabel: "Home",
  homeUrl: "/",
  showCurrent: true,
...
export const DEFAULT_BLOG_POST_HERO_SETTINGS: BlogPostHeroWidgetSettings = {
  breadcrumb: {
    show: true,
    color: "rgba(255,255,255,0.6)",
    separatorColor: "rgba(255,255,255,0.4)",
  },
  categoryPill: {
    show: true,
...
export const DEFAULT_BLOG_POST_CONTENT_SETTINGS: BlogPostContentWidgetSettings = {
  coverImage: {
    show: true,
    aspectRatio: "16:9",
    borderRadius: 16,
...
export const DEFAULT_BLOG_POST_TOC_SETTINGS: BlogPostTocWidgetSettings = {
  title: "On This Page",
  showTitle: true,
  headingLevels: [2],
  sticky: true,
...
export const DEFAULT_SOCIAL_SHARE_RAIL_SETTINGS: SocialShareRailWidgetSettings = {
  label: "SHARE",
  showLabel: true,
  layout: "vertical",
  sticky: true,
  ...
  counterValue: "1.2K",
  counterLabel: "SHARES",
  labelColor: "var(--color-muted-foreground, #64748b)",
  iconSize: 16,
  container: DEFAULT_WIDGET_CONTAINER,
};
...
export const DEFAULT_BLOG_POST_AUTHOR_CARD_SETTINGS: BlogPostAuthorCardWidgetSettings = {
  ...
  cardBorderColor: "var(--color-border, #e2e8f0)",
  cardBorderRadius: 16,
  cardPadding: 32,
  nameColor: "var(--color-card-foreground, #0f172a)",
...
export const DEFAULT_BLOG_POST_TAGS_SETTINGS: BlogPostTagsWidgetSettings = {
  label: "Tagged in",
  showLabel: true,
...
export const DEFAULT_NEWSLETTER_CTA_SETTINGS: NewsletterCtaWidgetSettings = {
  badge: {
    show: true,
    icon: "✉",
  ...
  subtitle: {
    show: true,
    text: "Join 5,000+ builders getting weekly tips on page design, CRM workflows, and growing with UIBldr.",
    color: "#cbd5e1",
    maxWidth: 560,
  },
  form: {
